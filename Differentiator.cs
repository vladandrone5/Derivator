    ...
    public static List<object> Derive(List<object> expression, string variable) {
        ...
        switch(op) {
            case "+": {
                ...
                if(firstOperand is string word) {
                    uList = new List<object> {firstOperand};
                }
                else {
                    uList = (List<object>) firstOperand;
                }
                ...
                if(secondOperand is string word) {
            ...
            case "^": {
                ...
                if(int.TryParse(v, out exponent)) {
                    ...
                    List<object> rightSide = new List<object> {"*", expoenent.ToString(), powerSide};
